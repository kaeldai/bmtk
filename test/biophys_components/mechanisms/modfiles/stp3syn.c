...
#define p0 _p[1]
#define p0_columnindex 1
#define tau_1 _p[2]
#define tau_1_columnindex 2
#define tau_r0 _p[3]
#define tau_r0_columnindex 3
#define tau_FDR _p[4]
#define tau_FDR_columnindex 4
#define a_FDR _p[5]
#define a_FDR_columnindex 5
#define tau_D _p[6]
#define tau_D_columnindex 6
#define a_D _p[7]
#define a_D_columnindex 7
#define i _p[8]
#define i_columnindex 8
#define n _p[9]
#define n_columnindex 9
#define tau_r _p[10]
#define tau_r_columnindex 10
#define D _p[11]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 stp3syn stp3syn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "stp3syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
