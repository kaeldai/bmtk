...
def check_spikes(file_path):
    ...
    return spikes_report['cortex'].run_checks([
        {'check': 'n_nodes', 'expected': 114},
        {'check': 'n_spikes', 'expected': 1197},
        {'check': 'mean_spikes_per_node', 'expected': 10.5000},
        {'check': 'min_timestamp', 'expected': 23.6720},
        {'check': 'max_timestamp', 'expected': 2970.2270},
        {'check': 'mean_firing_rate', 'expected': 3.5634},
    ])
