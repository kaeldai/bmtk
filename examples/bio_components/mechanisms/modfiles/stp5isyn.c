...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 stp5isyn stp5isyn.mod\n");
...
static void _initlists(){
 ...
 _slist1[3] = tau_r_columnindex;  _dlist1[3] = Dtau_r_columnindex;
 _slist1[4] = D_columnindex;  _dlist1[4] = DD_columnindex;
 _slist1[5] = pb_columnindex;  _dlist1[5] = Dpb_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "stp5isyn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
