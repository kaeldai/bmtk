...
#define p0 _p[2]
#define p0_columnindex 2
#define tau_f _p[3]
#define tau_f_columnindex 3
#define tau_1 _p[4]
#define tau_1_columnindex 4
#define i _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 stp4syn stp4syn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "stp4syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
